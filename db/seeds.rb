...
cillian = User.create(username: "cillian_wing", email: "cillian_wing@gmail.com", password: "test_password1")
elyssa = User.create(username: "elyssa_leal", email: "elyssa_leal@gmail.com", password: "test_password2")
